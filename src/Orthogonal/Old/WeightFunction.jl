...
abstract type AbstractWeightFunction{T} <: AbstractContinuousOrthogonalPolynomial{T} end
...
WeightFunction(pis::Type{<:AbstractContinuousOrthogonalPolynomial}, W, coeffs::Vector{T}=[0,1]; var::Symbol=:x) where {T} = WeightFunction(pis, W, coeffs, var)
